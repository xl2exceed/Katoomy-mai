        ...
        >
          ...
          <div className="flex items-center gap-2 px-3 py-2 bg-white border-t border-gray-100">
            <input
              ...
              disabled={loading}
              className="flex-1 text-sm px-3 py-2 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent disabled:opacity-50 bg-gray-50 text-gray-900 placeholder-gray-400"
              maxLength={500}
            />
            <button
              onClick={sendMessage}
