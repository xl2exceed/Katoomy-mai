        ...
        {calcOpen && (
          <div className="bg-white rounded-b-xl border border-t-0 border-gray-200 p-4">
            ...
            <div className="grid grid-cols-4 gap-2">
              ...
              <button onClick={() => calcOp("/")} className="py-4 bg-emerald-100 text-emerald-700 rounded-xl font-bold text-xl active:scale-95 transition">÷</button>
              ...
              <button onClick={calcEquals} className="py-4 bg-emerald-600 text-white rounded-xl font-bold text-xl active:scale-95 transition">=</button>
            </div>
