...
-- Generated 2026-05-26 from reading actual page source code
...
VALUES
  ...
  ('How do I auto-confirm bookings?',
   ...
   'Go to App Settings. Under New Bookings, toggle to Auto Confirm. Customers are confirmed instantly when they book. Click Save.'),

  ('How do I require manual approval for bookings?',
   'admin-desktop:how do i require manual approval for bookings',
   'Go to App Settings. Under New Bookings, toggle to Manual Approval. New bookings appear as Requested for you to confirm or decline. Click Save.'),

  ('How do I enable deposits?',
   'admin-desktop:how do i enable deposits',
   'Go to App Settings. Toggle Deposits on. To configure the deposit amount and type, go to Payment Settings in the sidebar.'),
  ...
  ('How do I set points per appointment?',
   ...
   'Go to Rewards. When the loyalty program is enabled, update the "Points Per Completed Appointment" field. Click Save Loyalty Settings.'),

  ('How do I set the reward threshold?',
   'admin-desktop:how do i set the reward threshold',
   'Go to Rewards. Update "Points Needed For Reward". Also set the Reward Type and Reward Description. Click Save Loyalty Settings.'),
  ...
  ('How do I edit a membership plan?',
   ...
   'Go to Membership. Find the plan and click Edit. Update the fields and click "Update Plan".'),

  ('How do I deactivate a membership plan?',
   'admin-desktop:how do i deactivate a membership plan',
   'Go to Membership. Find the plan and click Deactivate. Click Activate to re-enable it.'),

  ('How do I see my active members?',
   'admin-desktop:how do i see my active members',
   'Go to Membership. Scroll down to the Active Members table. It shows Customer, Phone, Plan name, Joined date, and Renews date.'),

  ('How do I send an SMS campaign?',
   'admin-desktop:how do i send an sms campaign',
   'Go to Campaigns in the sidebar. Click "New SMS". Select an audience (All Customers, At-Risk, Members Only, New Customers, Top Spenders, or No App Install), pick a message template, give the campaign a name, and click the send button. Messages are capped at 160 characters.'),

  ('What audience options are available for campaigns?',
   'admin-desktop:what audience options are available for campaigns',
   'Campaign audiences: All Customers (everyone with a phone), At-Risk (have not visited recently), Members Only (active Elite Members), New Customers (recently joined), Top Spenders (highest-value customers), No App Install (have not installed the app).'),

  ('How do I view past campaigns?',
   'admin-desktop:how do i view past campaigns',
   'Go to Campaigns. Click the "SMS History" tab to see all past campaigns with recipient count, sent count, and results.'),
  ...
  ('How do I see at-risk customers?',
   ...
   'Go to Analytics in the sidebar. Select any period. Scroll down to the At-Risk Customers section to see customers who have not visited recently.'),
  ...
  ('How do I change my business type?',
   ...
   'Go to App Settings. Tap the "App Settings" title 7 times quickly to reveal a hidden Business Type section. Select your niche (barber, car wash, lawn care) and click Save.'),
  ...
  ('How do I view my appointments?',
   ...
   'Tap Schedule. Use the Day or Week toggle at the top. Navigate dates with the Previous and Next arrow buttons.'),

  ('How do I confirm a booking?',
   'admin-mobile:how do i confirm a booking',
   'Open Schedule. Find the booking and use the status dropdown to select Confirmed.'),

  ('How do I cancel an appointment?',
   'admin-mobile:how do i cancel an appointment',
   'Open Schedule. Find the booking and use the status dropdown to select Cancelled.'),

  ('How do I mark a booking complete?',
   'admin-mobile:how do i mark a booking complete',
   'Open Schedule. Find the booking and use the status dropdown to select Completed.'),

  ('How do I refund a payment?',
   'admin-mobile:how do i refund a payment',
   'Open Schedule. Find a booking with paid status — a Refund button appears. Tap it, choose Full Refund or Partial Refund, select a reason, and tap Confirm Refund.'),

  ('How do I take a payment?',
   'admin-mobile:how do i take a payment',
   'Tap Take Payment. Enter the customer phone number to look them up. If they have an open balance it shows automatically. Choose QR Payment (card), Cash, Cash App, or Zelle.'),

  ('How do I record a cash payment?',
   'admin-mobile:how do i record a cash payment',
   'Tap Take Payment, enter the customer phone number, select a service if needed, and tap Cash to record it.'),

  ('How do I generate a QR code for payment?',
   'admin-mobile:how do i generate a qr code for payment',
   'Tap Take Payment. Enter the customer phone, select a service if needed, and tap Generate QR Payment. Show the QR code for the customer to scan with their phone.'),

  ('How do I view my revenue?',
   'admin-mobile:how do i view my revenue',
   'Tap Revenue. Filter by Today, This Week, This Month, or All Time to see your totals.'),
  ...
  ('How do I charge a custom amount?',
   ...
   'Tap Take Payment. Scroll down to the Custom Payment section. Enter a Service or Description, Amount, and optionally Tip and Customer Name. Tap Cash, Cash App, Zelle, or Generate QR (Credit Card).'),

  ('How do I log out?',
   'admin-mobile:how do i log out',
   'Open the menu and tap Log out, or go back to the main mobile menu and tap Sign Out.'),
  ...
  ('How do I take a payment?',
   ...
   'From the dashboard, tap Take Payment. Enter the customer phone number to look them up. If they have an open balance it shows automatically. Tap Generate QR Payment (card), Cash, Cash App, or Zelle.'),
  ...
  ('How do I mark a booking as paid?',
   ...
   'Use Take Payment to record the payment. Enter the customer phone number — if they have an open booking, it will be found automatically. Choose Cash, Cash App, Zelle, or Generate QR Payment to record it as paid.')

ON CONFLICT (normalized_question) DO UPDATE SET
  answer = EXCLUDED.answer,
  question = EXCLUDED.question;

-- Total: 88 entries inserted/updated
