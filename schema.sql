...
CREATE TABLE IF NOT EXISTS "public"."businesses" (
    ...
    "default_booking_status" "text" DEFAULT 'confirmed'::"text" NOT NULL,
    "address" "text",
...
CREATE TABLE IF NOT EXISTS "public"."notification_log" (
    ...
    CONSTRAINT "notification_log_target_type_check" CHECK (("target_type" = ANY (ARRAY['business'::"text", 'customer'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."notification_rules" (
    ...
    "max_per_customer_per_day" integer DEFAULT 3 NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "notification_rules_applies_to_check" CHECK (("applies_to" = ANY (ARRAY['all'::"text", 'confirmed_only'::"text", 'services'::"text", 'staff'::"text"]))),
    CONSTRAINT "notification_rules_channel_check" CHECK (("channel" = 'sms'::"text")),
    CONSTRAINT "notification_rules_inactive_days_check" CHECK (("inactive_days" > 0)),
    CONSTRAINT "notification_rules_kind_check" CHECK (("kind" = ANY (ARRAY['appointment_reminder'::"text", 'winback'::"text"]))),
    CONSTRAINT "notification_rules_max_per_customer_per_day_check" CHECK (("max_per_customer_per_day" > 0)),
    CONSTRAINT "notification_rules_offset_minutes_check" CHECK (("offset_minutes" > 0))
);
...
CREATE TABLE IF NOT EXISTS "public"."push_subscriptions" (
    ...
    "customer_id" "uuid",
    "business_id" "uuid",
    CONSTRAINT "push_subscriptions_user_type_check" CHECK (("user_type" = ANY (ARRAY['customer'::"text", 'business'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."scheduled_messages" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "scheduled_messages_status_check" CHECK (("status" = ANY (ARRAY['scheduled'::"text", 'processing'::"text", 'sent'::"text", 'failed'::"text", 'canceled'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."scheduled_notifications" (
    ...
    "status" "text" DEFAULT 'pending'::"text" NOT NULL,
    CONSTRAINT "scheduled_notifications_channel_check" CHECK (("channel" = ANY (ARRAY['sms'::"text", 'push'::"text"]))),
    CONSTRAINT "scheduled_notifications_status_check" CHECK (("status" = ANY (ARRAY['pending'::"text", 'sent'::"text", 'failed'::"text", 'skipped'::"text"]))),
    CONSTRAINT "scheduled_notifications_type_check" CHECK (("type" = ANY (ARRAY['reminder_24h'::"text", 'reminder_2h'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."tips" (
    ...
    CONSTRAINT "tips_status_check" CHECK (("status" = ANY (ARRAY['pending'::"text", 'paid'::"text", 'failed'::"text"])))
);
...
ALTER TABLE ONLY "public"."tips"
    ADD CONSTRAINT "tips_stripe_session_key" UNIQUE ("stripe_session_id");
...
CREATE INDEX "idx_notification_log_business" ON "public"."notification_log" USING "btree" ("business_id", "created_at" DESC);



CREATE INDEX "idx_notification_log_customer" ON "public"."notification_log" USING "btree" ("customer_id", "created_at" DESC);
...
CREATE INDEX "idx_scheduled_notifications_due" ON "public"."scheduled_notifications" USING "btree" ("scheduled_for", "status") WHERE ("status" = 'pending'::"text");
...
ALTER TABLE ONLY "public"."notification_rules"
    ADD CONSTRAINT "notification_rules_business_id_fkey" FOREIGN KEY ("business_id") REFERENCES "public"."businesses"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."push_subscriptions"
    ADD CONSTRAINT "push_subscriptions_customer_id_fkey" FOREIGN KEY ("customer_id") REFERENCES "public"."customers"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."scheduled_messages"
    ADD CONSTRAINT "scheduled_messages_appointment_id_fkey" FOREIGN KEY ("appointment_id") REFERENCES "public"."bookings"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."scheduled_messages"
    ADD CONSTRAINT "scheduled_messages_business_id_fkey" FOREIGN KEY ("business_id") REFERENCES "public"."businesses"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."scheduled_messages"
    ADD CONSTRAINT "scheduled_messages_customer_id_fkey" FOREIGN KEY ("customer_id") REFERENCES "public"."customers"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."scheduled_messages"
    ADD CONSTRAINT "scheduled_messages_rule_id_fkey" FOREIGN KEY ("rule_id") REFERENCES "public"."notification_rules"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."scheduled_messages"
    ADD CONSTRAINT "scheduled_messages_sent_message_id_fkey" FOREIGN KEY ("sent_message_id") REFERENCES "public"."sms_messages"("id");
...
ALTER TABLE ONLY "public"."scheduled_notifications"
    ADD CONSTRAINT "scheduled_notifications_business_id_fkey" FOREIGN KEY ("business_id") REFERENCES "public"."businesses"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."scheduled_notifications"
    ADD CONSTRAINT "scheduled_notifications_customer_id_fkey" FOREIGN KEY ("customer_id") REFERENCES "public"."customers"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."tips"
    ADD CONSTRAINT "tips_business_id_fkey" FOREIGN KEY ("business_id") REFERENCES "public"."businesses"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."tips"
    ADD CONSTRAINT "tips_customer_id_fkey" FOREIGN KEY ("customer_id") REFERENCES "public"."customers"("id") ON DELETE CASCADE;
...
CREATE POLICY "Premium owners can delete their staff" ON "public"."staff" FOR DELETE TO "authenticated" USING (("business_id" IN ( SELECT "b"."id"
...
CREATE POLICY "Premium owners can insert staff" ON "public"."staff" FOR INSERT TO "authenticated" WITH CHECK (("business_id" IN ( SELECT "b"."id"
   FROM "public"."businesses" "b"
  WHERE (("b"."owner_user_id" = "auth"."uid"()) AND (("b"."subscription_plan" = ANY (ARRAY['premium'::"text", 'pro'::"text"])) OR (("b"."features" ->> 'staff_management'::"text") = 'true'::"text"))))));



CREATE POLICY "Premium owners can update their staff" ON "public"."staff" FOR UPDATE TO "authenticated" USING (("business_id" IN ( SELECT "b"."id"
   FROM "public"."businesses" "b"
  WHERE (("b"."owner_user_id" = "auth"."uid"()) AND (("b"."subscription_plan" = ANY (ARRAY['premium'::"text", 'pro'::"text"])) OR (("b"."features" ->> 'staff_management'::"text") = 'true'::"text")))))) WITH CHECK (("business_id" IN ( SELECT "b"."id"
   FROM "public"."businesses" "b"
  WHERE (("b"."owner_user_id" = "auth"."uid"()) AND (("b"."subscription_plan" = ANY (ARRAY['premium'::"text", 'pro'::"text"])) OR (("b"."features" ->> 'staff_management'::"text") = 'true'::"text"))))));



CREATE POLICY "Premium owners can view their staff" ON "public"."staff" FOR SELECT TO "authenticated" USING (("business_id" IN ( SELECT "b"."id"
   FROM "public"."businesses" "b"
  WHERE (("b"."owner_user_id" = "auth"."uid"()) AND (("b"."subscription_plan" = ANY (ARRAY['premium'::"text", 'pro'::"text"])) OR (("b"."features" ->> 'staff_management'::"text") = 'true'::"text"))))));
...
CREATE POLICY "Public can view active staff for premium businesses" ON "public"."staff" FOR SELECT TO "authenticated", "anon" USING ((("is_active" = true) AND ("business_id" IN ( SELECT "b"."id"
   FROM "public"."businesses" "b"
...
CREATE POLICY "service_role_full_access" ON "public"."tips" USING (true) WITH CHECK (true);
...
GRANT ALL ON TABLE "public"."customer_loyalty_summary" TO "anon";
GRANT ALL ON TABLE "public"."customer_loyalty_summary" TO "authenticated";
